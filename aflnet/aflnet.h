...
//NGAP/NAS
unsigned int* extract_response_codes_ngap(unsigned char* buf, unsigned int buf_size, unsigned int* state_count_ref);
unsigned int* extract_response_codes_nas(unsigned char* buf, unsigned int buf_size, unsigned int* state_count_ref);
...
//NGAP/NAS
region_t* extract_requests_ngap(unsigned char* buf, unsigned int buf_size, unsigned int* region_count_ref);
region_t* extract_requests_nas(unsigned char* buf, unsigned int buf_size, unsigned int* region_count_ref);
